...
dependencies {
    ...
    // Vert.x Shell
    implementation("io.vertx:vertx-shell:3.8.3")
    ...
    implementation(project(":pumpkin-network"))
    ...
    implementation(project(":pumpkin-world"))
}

application {
    mainClassName = "pumpkin.launcher.LauncherKt"
}
